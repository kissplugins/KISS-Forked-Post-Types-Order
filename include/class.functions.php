    ...
    class CptoFunctions
        {
            ...
            */
            function cpt_info_box()
                {
                    ?>
                        <div id="cpt_info_box" style="border: 1px dashed #6aadcc; background-color: #FFF; margin-top: 10px; box-shadow: 1px 1px 7px rgba(50, 50, 50, 0.17);">
                            <div style="padding: 8px 10px; cursor: pointer; user-select: none; background: #f9f9f9; border-bottom: 1px dashed #6aadcc;" onclick="toggleInfoPanel()">
                                <span id="info-caret" style="display: inline-block; transition: transform 0.2s;">▶</span>
                                <strong style="color: #0073aa;">ℹ️ Plugin Information & Support (Click to expand)</strong>
                            </div>
                            <div id="info-content" style="display: none; padding: 10px;">
                        ...
                        function toggleInfoPanel() {
                            ...
                            var caret = document.getElementById("info-caret");
